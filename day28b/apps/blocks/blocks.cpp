...
const int kNumBlocksX = 10;
const int kNumBlocksY = 5;
const int kBlockWidth = 20;
const int kBlockHeight = 10;
const int kBarWidth = 30;
const int kBarHeight = 5;
const int kBallRadius = 5;
const int kGapWidth = 30;
const int kGapHeight = 30;
const int kGapBar = 80;
const int kBarFloat = 10;
...
extern "C" void main(int argc, char **argv)
{
    ...
    for (;;)
    {
        ...
        int ball_x_ = ball_x + ball_dx;
        int ball_y_ = ball_y + ball_dy;
        ...
        if (ball_dy < 0 && ball_y_ < kBallRadius)
        {
            ball_dir = -ball_dir;
                 ...
                 ball_dy > 0 && kBallY - kBallRadius <= ball_y_)
        {
            ball_dir = -ball_dir;
        }
